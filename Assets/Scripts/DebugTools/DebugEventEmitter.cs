...
namespace Game.DebugTools
{
    ...
    public class DebugEventEmitter : MonoBehaviour
    {
        ...
        {
            EventBus.Publish(new EnemyHitBatchEvent(enemyId, hitCount, bodyDamage, transform.position, transform));
        ...
        {
            EventBus.Publish(new EnemyHitBatchEvent(enemyId, 1, 0f, transform.position, transform));
        ...
        {
            EventBus.Publish(new EnemyHitBatchEvent(enemyId, 1, 999f, transform.position, transform));
